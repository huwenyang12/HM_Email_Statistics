...
# 巡检计划
platform_schedules = {
    '网管中心-基础资源': [("07:30", 120), ("11:30", 120), ("16:30", 120)],
    '网管中心-网络安全': [("08:30", 30), ("11:30", 30), ("15:30", 30)],
    '网管中心-北京通业务系统': [("07:30", 10), ("16:30", 10)],
    '权益平台（政务外网）-基础资源': [("08:00", 120), ("12:00", 120), ("14:30", 120), ],
    '权益平台（政务外网）-网络安全': [("09:15", 60), ("11:15", 60), ("16:00", 60)],
    '权益平台（政务外网）-系统负载': [("09:30", 60)],
    '权益平台（互联网）-网络安全': [("08:00", 30), ("11:00", 30),("15:30", 30)],
    '权益平台（互联网）-基础资源': [("08:10", 60), ("12:10", 60), ("16:00", 60)],
    '综合系统（腾讯云）-网络安全': [("08:00", 30),("12:00", 30), ("16:00", 30)],
    '民生卡业务网络专线': [("08:10", 30), ("12:10", 30),("16:10", 30)],
    '综合系统（腾讯云）-基础资源': [("08:30", 60), ("12:30", 60), ("15:00", 60)],
}
